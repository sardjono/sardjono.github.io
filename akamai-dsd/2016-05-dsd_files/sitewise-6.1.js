...
//use AKAUSER cookie, rather than AKASESSION
var akacookie = readCookie('AKAUSER');
if(akacookie != null){
	var webTrends_userName = akacookie;
}
...
function dcsVar(){
	...
	//added browser check by MDH for IE7 issue with addBehavior in WT code
...
DCSext["webTrends_userName"] = webTrends_userName ;
